        ...
        <Container className="relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed mb-12">
              We help you simplify, focus, and build. With strategy, empathy, and the latest AI and analytics tools always working behind the scenes — for you.
            </p>
          </motion.div>
        </Container>
      </Section>
        ...
        <Container>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {[
              ...
              >
                ...
                >
                  <div className={`w-16 h-16 bg-gradient-to-r from-${problem.color}-500 to-${problem.color}-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500 shadow-lg`}>
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Businesses spending more time managing their tools than achieving their goals.
            </p>
