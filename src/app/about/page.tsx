            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div>
                ...
                <div className="space-y-6">
                  <div className="bg-neutral-800/50 rounded-xl p-6 border border-neutral-700">
                    <h3 className="text-lg font-semibold text-white mb-2">Money wasted on tools</h3>
                    <p className="text-neutral-300">That don't integrate or deliver value.</p>
                  </div>
                  
                  <div className="bg-neutral-800/50 rounded-xl p-6 border border-neutral-700">
                    <h3 className="text-lg font-semibold text-white mb-2">Teams struggling</h3>
                    <p className="text-neutral-300">With disconnected workflows and processes.</p>
                  </div>
                  
                  <div className="bg-neutral-800/50 rounded-xl p-6 border border-neutral-700">
                    <h3 className="text-lg font-semibold text-white mb-2">Complexity distracts</h3>
                    <p className="text-neutral-300">From core business objectives.</p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-xl p-8 border border-blue-500/30">
                  ...
                  <blockquote className="text-xl text-blue-300 font-medium italic">
