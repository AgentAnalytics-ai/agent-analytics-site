    ...
    >
      ...
      <Container className="relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          ...
          >
            <Card className="p-6 text-center hover-lift">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">The Social Capital</h3>
          ...
          >
            <Card className="p-6 text-center hover-lift">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Technology Leaders</h3>
              <p className="text-gray-600">Innovators & executives</p>
            </Card>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            <Card className="p-6 text-center hover-lift">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">2-Hour Format</h3>
              <p className="text-gray-600">Structured networking</p>
            </Card>
          </motion.div>
        </div>
        ...
        <motion.div
          ...
          className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-8 text-center mb-12"
        >
