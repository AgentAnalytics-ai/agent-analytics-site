...
import { Brain, Code, Zap, ArrowRight, CheckCircle, Lightbulb, Target, TrendingUp, Users } from 'lucide-react';
...
export default function ServicesPage() {
  const services = [
    ...
    },
    {
      ...
      description: 'I build intelligent systems that actually work for your business. No off-the-shelf solutions—just custom AI that understands your unique challenges and delivers real results.',
      features: ['Custom AI Models', 'Intelligent Automation', 'Predictive Analytics', 'Integration Development'],
      benefits: ['Reduced operational costs', 'Competitive advantage', 'Scalable solutions'],
  ...
  return (
    <>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">Results-Focused</h3>
                    <p className="text-gray-600 text-sm">Every AI solution I build is designed to deliver measurable business outcomes, not just technical achievements.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <Users className="w-6 h-6 text-blue-600 mt-1 flex-shrink-0" />
                  <div>
                    <h3 className="font-semibold text-gray-900">Team-Centric</h3>
                    <p className="text-gray-600 text-sm">I ensure your team can actually use and benefit from the AI systems we build together.</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="bg-white rounded-2xl p-8 shadow-xl">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900">Understand Your Reality</h4>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900">Build Custom Solutions</h4>
                    <p className="text-gray-600 text-sm">Design and develop AI that fits your specific needs</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900">Ensure Success</h4>
                    <p className="text-gray-600 text-sm">Train your team and optimize for maximum impact</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Services Grid */}
      <Section spacing="xl" background="gray" id="services" className="relative">
        <div className="absolute inset-0 bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-50"></div>
        <Container className="relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              End-to-end AI consulting, development, and enablement—tailored to your business and your goals.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {services.map((service, index) => {
              ...
              return (
                <Card key={index} className="relative text-left hover:shadow-2xl transition-all duration-500 group border-0 bg-white/80 backdrop-blur-sm hover:bg-white/90 hover:-translate-y-2">
                  <div className={`p-4 rounded-2xl ${service.iconBg} text-white shadow-lg mb-6 group-hover:scale-110 transition-transform duration-300`}>
                  ...
                  <div className="mb-6">
                    ...
                    <ul className="space-y-2 mb-4">
                      {service.features.map((feature, featureIndex) => (
                        <li key={featureIndex} className="flex items-start text-gray-600 group-hover:text-gray-700 transition-colors">
                    ...
                    <ul className="space-y-2">
                      {service.benefits.map((benefit, benefitIndex) => (
                        <li key={benefitIndex} className="flex items-start text-gray-600 group-hover:text-gray-700 transition-colors">
      ...
      {/* CTA Section */}
      <Section spacing="xl" background="dark" className="relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900"></div>
