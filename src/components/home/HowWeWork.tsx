...
import { Search, Palette, Rocket, ArrowRight, Sparkles, Zap, Target } from 'lucide-react';
      ...
      <Container className="relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Our proven process delivers results through strategic thinking and intelligent execution.
          </p>
        </motion.div>
            ...
            {steps.map((step, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <div className={`w-14 h-14 bg-gradient-to-r ${step.gradient} rounded-full flex items-center justify-center text-lg font-bold text-white shadow-lg ${step.shadowColor} border-4 border-white/20 backdrop-blur-sm`}>
                      {index + 1}
                    </div>
                  </motion.div>
                    ...
                    >
                      ...
                      <div className="relative z-10">
                        ...
                        <div className="text-center">
                          <h3 className={`text-3xl font-bold mb-6 bg-gradient-to-r ${step.gradient} bg-clip-text text-transparent group-hover:text-gray-900 transition-colors duration-500`}>
                            {step.title}
                          </h3>
                        ...
                        <motion.div 
                          ...
                          whileHover={{ x: 0 }}
                        >
                          <ArrowRight className={`w-6 h-6 text-${step.color}-500`} />
                        </motion.div>
                      </div>
                    </Card>
                  </motion.div>
