...
export function Trust() {
  const testimonials = [
    {
      quote:
        'Agent Analytics transformed our business strategy and helped us achieve 40% growth in just 18 months. Their insights were invaluable and their execution was flawless.',
    ...
    {
      quote:
        'The team&apos;s expertise in product development and market analysis helped us launch our platform successfully and secure Series A funding. They&apos;re true strategic partners.',
      author: 'Michael Chen',
      title: 'Founder & CEO',
    ...
    {
      quote:
        'Working with Agent Analytics was a game-changer. Their strategic approach and execution excellence exceeded our expectations and delivered measurable results.',
