        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="mt-4 text-gray-400 max-w-md">
              We help businesses simplify, consolidate, and optimize their software and AI workflows. 
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/services" className="hover:text-white transition-colors">Custom AI Development</Link></li>
              <li><Link href="/services" className="hover:text-white transition-colors">Process Automation</Link></li>
              <li><Link href="/services" className="hover:text-white transition-colors">Data Analytics & Insights</Link></li>
              <li><Link href="/services" className="hover:text-white transition-colors">AI Training & Adoption</Link></li>
            </ul>
          </div>
