    ...
    <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:to-blue-950">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
        ...
        >
          ...
          >
            Let&apos;s discuss how AI can drive growth and efficiency for your
            organization. Our local expertise means we understand your market
            and can deliver solutions that work for {city.name} businesses.
          </motion.p>
        </motion.div>
          ...
          <motion.div variants={itemVariants} className="text-center">
            <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl p-8 text-white shadow-xl">
              ...
              <p className="text-blue-100 mb-8 max-w-md mx-auto">
                Book a 30-minute strategy session to discuss your AI needs and
                discover how we can help your {city.name} business thrive.
              </p>
