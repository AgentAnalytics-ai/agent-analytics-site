    ...
    <section id="services" className="py-20 bg-gray-50 dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
        ...
        >
          ...
          >
            We bring world-class AI expertise to {city.name}, {city.state}. Our services are tailored to meet the unique challenges and opportunities of your local market.
          </motion.p>
        </motion.div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg border border-gray-200 dark:border-gray-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm text-gray-600 dark:text-gray-300">
              <div className="flex flex-col items-center">
                ...
                <p className="text-center">Local market understanding and business relationships</p>
              </div>
              <div className="flex flex-col items-center">
                <div className="w-12 h-12 bg-green-100 dark:bg-green-900 rounded-full flex items-center justify-center mb-3">
                  <span className="text-green-600 dark:text-green-400 text-xl">⚡</span>
                </div>
                <p className="text-center">Faster response times and on-site support when needed</p>
              </div>
              <div className="flex flex-col items-center">
                <div className="w-12 h-12 bg-purple-100 dark:bg-purple-900 rounded-full flex items-center justify-center mb-3">
                  <span className="text-purple-600 dark:text-purple-400 text-xl">🤝</span>
                </div>
                <p className="text-center">Personalized service and long-term partnership focus</p>
              </div>
            </div>
          </div>
        </motion.div>
