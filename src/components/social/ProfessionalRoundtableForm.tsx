    ...
    return (
      <div className="max-w-md mx-auto">
        ...
        >
          ...
          <h3 className="text-2xl font-bold text-gray-900 mb-2">Successfully Registered!</h3>
          <p className="text-gray-600 mb-6">
            Thanks for joining our Professional Roundtable! You'll receive event details and updates via email soon.
          </p>
          <Button
    ...
    <div className="max-w-md mx-auto">
      <div className="bg-white rounded-lg shadow-sm p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            {isSubmitting ? 'Registering...' : 'Register for Roundtable'}
          </Button>
        </form>
      </div>
    </div>
